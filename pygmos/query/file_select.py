...
FILTERS = ['open', 'u', 'g', 'r', 'i', 'z', 'Y', 'Z',
           'Lya395', 'HeII', 'HeIIC', 'OIII', 'OIIIC', 'Ha', 'HaC', 'SII', 
'CaT']
...
def mkFileList(argv):
    ...
    parser.add_argument('outFile', type=str,
                        help='Name of output file containing list of input 
files')
...
(yyyy-mm-dd:yyyy-mm-dd)')
    ...
    # A call to fileListQuery will need a dictionary something like the 
following
    queryDict = {'use_me':1,
